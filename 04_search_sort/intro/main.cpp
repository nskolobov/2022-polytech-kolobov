...
int main()
{
    ...
    int result_linear_search = linear_search(arr, n, x);
    ...
    {
        std::cout << "Element is present at index " << result_linear_search << std::endl;
    }
    int result_binary_search = binary_search(arr, 0, n - 1, x);
    ...
    {
        std::cout << "Element is present at index " << result_binary_search << std::endl;
    }
    return 0;
}
